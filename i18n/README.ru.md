...
Посетите [официальный сайт](https://github.com/OmniNodeCo/OmniLauncher-MC) чтобы скачать программу !
...
Для разработчика локализации i18n, пожалуйста, перейдите по ссылке [Начало работы с локализацией](https://github.com/OmniNodeCo/OmniLauncher-MC/en/guide/i18n)
## ЛИЦЕНЗИЯ
