...
请去 [官网](https://github.com/OmniNodeCo/OmniLauncher-MC) 下载启动器！
...
- 🔑 **代码签名与现代的安装模式**。在 Windows 中下载 OmniLauncher-MC 的 `appx` 与 `appinstaller`，您不会再看到浏览器的危险软件提示，因为 OmniLauncher-MC 已经获得签名证书！😎
