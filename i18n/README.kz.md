...
Қолданбаны жүктеп алу үшін [ресми сайтқа](https://github.com/OmniNodeCo/OmniLauncher-MC) кіріңіз!
...
i18n локализация әзірлеушісі үшін [Локализацияны бастау] (https://github.com/OmniNodeCo/OmniLauncher-MC/en/guide/i18n) бөлімін орындаңыз.
...
| :----------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy), OmniLauncher-MC серверсіз JavaScript қолданбалары үшін қиындықсыз платформасын пайдаланады. Берген [Deno](https://deno.com/)   |
