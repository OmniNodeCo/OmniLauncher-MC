...
公式サイト](https://github.com/OmniNodeCo/OmniLauncher-MC)にアクセスしてアプリをダウンロードしてください！
...
国際化ローカライゼーション開発者は、[ローカライゼーション入門](https://github.com/OmniNodeCo/OmniLauncher-MC/en/guide/i18n) を参照してください。
