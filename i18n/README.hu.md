...
Látogasd meg a [hivatalos honlapot](https://github.com/OmniNodeCo/OmniLauncher-MC) az alkalmazás letöltéséhez!
...
i18n lokalizációs fejlesztőknek kérjük kövessétek az [Első lépések a lokalizációban](https://github.com/OmniNodeCo/OmniLauncher-MC/en/guide/i18n) útmutatót
...
| :----------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy), OmniLauncher-MC a problémamentes platformját használja serverless JavaScript alkalmazásokhoz. A [Deno](https://deno.com/) biztosítja   |
