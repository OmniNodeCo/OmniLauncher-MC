...
Відвідайте [оффіційну сторінку](https://github.com/OmniNodeCo/OmniLauncher-MC) щоб завантажити програму!
...
Для розробника локалізації i18n, будь ласка, перейдіть за посиланням [Початок роботи з локалізацією](https://github.com/OmniNodeCo/OmniLauncher-MC/en/guide/i18n)
