...
```bash
git clone --recurse-submodules https://github.com/your-id/OmniLauncher-MC
```
...
Under the folder you cloned, e.g. `OmniLauncher-MC`, run command
...
- omnilauncher-ui/locales
- omnilauncher-electron-app/main/locales
