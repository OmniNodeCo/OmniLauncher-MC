...
공식 사이트([https://github.com/OmniNodeCo/OmniLauncher-MC](https://github.com/OmniNodeCo/OmniLauncher-MC/ko))에서 앱을 다운로드할 수 있어요.
...
번역(i18n) 작업을 하려면 [현지화를 시작하기](https://github.com/OmniNodeCo/OmniLauncher-MC/ko/guide/i18n)를 따라 진행해 주세요.
...
| :----------------------------------------------------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------: |
| [![](https://deno.com/images/deno_logo_4.gif)](https://deno.com/deploy) | [Deno Deploy](https://deno.com/deploy), OmniLauncher-MC은 서버리스 자바스크립트 앱에 Deno Deploy를 활용하고 있어요. 제공: [Deno](https://deno.com/) |
