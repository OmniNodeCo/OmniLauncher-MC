...
export const DEVELOPMENT_OMNI_BILLING_API_BASE_URL = 'https://api-staging.xmcl.app'
...
export function applyDevelopmentApiFlight(
  ...
  if (environment === 'development') {
    flights.xmclBillingApiBaseUrl = DEVELOPMENT_OMNI_BILLING_API_BASE_URL
  }
  return flights
}
...
export function applyRemoteFlights(
  ...
  if (
    ...
    persisted.xmclBillingApiBaseUrl === DEVELOPMENT_OMNI_BILLING_API_BASE_URL
  ) {
