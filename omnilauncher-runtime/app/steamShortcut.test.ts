...
describe('addSteamShortcutToVdf', () => {
  const shortcut = {
    executable: '"/home/deck/OmniLauncher-MC"',
    startDir: '"/home/deck"',
    icon: '/home/deck/OmniLauncher-MC',
  }
  ...
  test('appends a shortcut without rewriting existing binary-VDF entries', () => {
    ...
    expect(updated!.toString('utf8')).toContain('OmniLauncher-MC')
  })

  test('does not add a second launcher shortcut', () => {
    const launcher = object('0', string('AppName', 'OmniLauncher-MC'))
