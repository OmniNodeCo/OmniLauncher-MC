...
const keys = vi.hoisted(() => ({
  ...
  accountService: Symbol('OmniLauncherAccountService'),
  authorization: Symbol('kOmniSessionAuthorization'),
}))

vi.mock('~/infra', () => ({ kFlights: keys.flights }))
vi.mock('~/omnilauncherAccount/OmniLauncherAccountService', () => ({
  OmniLauncherAccountService: keys.accountService,
  kOmniSessionAuthorization: keys.authorization,
}))
