...
import type { XmclAccountState, XmclOAuthProvider } from '../entities/omnilauncherAccount'
...
export interface OmniLauncherAccountService {
...
export const OmniLauncherAccountServiceKey: ServiceKey<OmniLauncherAccountService> = 'OmniLauncherAccountService'
