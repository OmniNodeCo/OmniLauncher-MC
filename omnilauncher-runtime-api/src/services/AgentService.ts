...
/** Model selected by the built-in OmniLauncher-MC provider. */
export const BUILTIN_AGENT_MODEL = 'xmcl-agent'
/** Provider id used for the built-in OmniLauncher-MC provider. */
export const BUILTIN_AGENT_PROVIDER_ID = 'omnilauncher'
/** Default-off flight enabling the built-in OmniLauncher-MC provider. */
