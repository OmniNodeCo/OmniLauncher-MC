...
[![Downloads](https://img.shields.io/npm/dm/@xmcl/user.svg)](https://npmjs.com/@xmcl/user)
[![Install size](https://packagephobia.now.sh/badge?p=@xmcl/user)](https://packagephobia.now.sh/result?p=@xmcl/user)
[![npm](https://img.shields.io/npm/l/@xmcl/minecraft-launcher-core.svg)](https://github.com/OmniNodeCo/minecraft-launcher-core-node/blob/master/LICENSE)
[![Build Status](https://github.com/OmniNodeCo/minecraft-launcher-core-node/workflows/Build/badge.svg)](https://github.com/OmniNodeCo/minecraft-launcher-core-node/actions?query=workflow%3ABuild)
...
If you want a reference, [this](https://github.com/OmniNodeCo/OmniLauncher-MC/blob/master/omnilauncher-runtime/lib/clients/MicrosoftOAuthClient.ts) is the live example for nodejs/electron using msal-node.
