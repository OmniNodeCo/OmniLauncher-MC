...
const renderLink = (fileName: string, line: number) => `<a href="https://github.com/OmniNodeCo/OmniLauncher-MC/blob/master/${fileName}#L${line}" target="_blank" rel="noreferrer">${fileName}:${line}</a>`
