...
export class ElectronController implements LauncherAppController {
  ...
  async startMigrate() {
    ...
    const browser = new BrowserWindow({
      title: 'OmniLauncher-MC Launcher Migrate',
      frame: false,
      resizable: false,
      width: 600,
      height: 400,
  ...
  async createBrowseWindow() {
    ...
    const browser = new BrowserWindow({
      title: 'OmniLauncher-MC Launcher Browser',
      frame: false,
      transparent: true,
      resizable: false,
      width: 860,
    ...
    return new Promise<string>((resolve, reject) => {
      ...
      const browser = new BrowserWindow({
        ...
        webPreferences: {
          ...
          sandbox: true,
          partition: 'persist:omnilauncher-microsoft-login',
        },
        show: false,
      })
      const finish = (
