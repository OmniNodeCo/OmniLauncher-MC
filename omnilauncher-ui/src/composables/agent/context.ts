...
export function resolveAgentSessionSystemPrompt(stored: string | undefined, generated: string, compacted: boolean) {
  const renamedVfsShell = stored?.includes('The `bash` tool is a virtual OmniLauncher-MC command runner') && generated.includes('The `vfs_shell` tool is a virtual OmniLauncher-MC command runner')
