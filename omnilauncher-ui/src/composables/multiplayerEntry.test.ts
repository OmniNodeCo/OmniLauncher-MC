...
describe('multiplayer entry', () => {
  it('opens the multiplayer window immediately for an OmniLauncher-MC account', () => {
  ...
  it('waits for OmniLauncher-MC login before opening the multiplayer window', async () => {
