...
export function useMultiplayerEntry(): MultiplayerEntryController {
  ...
  return {
    account: omnilauncherAccount.account,
    busy: omnilauncherAccount.busy,
    error: omnilauncherAccount.error,
    isShown,
    authorizeProvider: omnilauncherAccount.authorizeProvider,
