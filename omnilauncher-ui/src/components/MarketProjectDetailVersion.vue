...
const loaders = computed(() => props.version.loaders.map(l => {
  if (l.toLowerCase() === 'vanilla') return { icon: 'omni:minecraft', loader: l }
  if (l.toLowerCase() === 'forge') return { icon: 'omni:forge', loader: l }
  if (l.toLowerCase() === 'fabric') return { icon: 'omni:fabric', loader: l }
  if (l.toLowerCase() === 'quilt') return { icon: 'omni:quilt', loader: l }
  if (l.toLowerCase() === 'neoforge') return { icon: 'omni:neoForged', loader: l }
  if (l.toLowerCase() === 'iris') return { icon: 'omni:iris', loader: l }
  if (l.toLowerCase() === 'optifine') return { icon: 'omni:optifine', loader: l }
  return { loader: l }
}))
