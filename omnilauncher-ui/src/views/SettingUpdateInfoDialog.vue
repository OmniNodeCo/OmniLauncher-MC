<template>
  ...
  >
    ...
    <v-card
      ...
      style="width: 100%"
      to="https://github.com/OmniNodeCo/OmniLauncher-MC/releases"
      target="browser"
      push
    >
...
const openOfficialWebsite = () => {
  window.open('https://github.com/OmniNodeCo/OmniLauncher-MC', 'browser')
}
const openGithub = () => {
  window.open('https://github.com/OmniNodeCo/OmniLauncher-MC/releases', 'browser')
}
</script>
