...
import { BaseServiceKey, OmniLauncherAccountServiceKey, type XmclTogetherOrder, type XmclTogetherOverview } from '@xmcl/runtime-api'
...
const togetherService = useService(OmniLauncherAccountServiceKey)
